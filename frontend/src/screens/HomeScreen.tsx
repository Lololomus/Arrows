...
export function HomeScreen() {
  ...
  return (
    <div className="flex flex-col h-full px-6 pt-4 pb-24 justify-center gap-8">
      ...
      >
        <div className="absolute inset-0 bg-purple-500 rounded-3xl blur-xl opacity-40 group-hover:opacity-60 transition-opacity animate-pulse"></div>
      ...
      >
        <div className="absolute inset-0 bg-cyan-500 rounded-3xl blur-xl opacity-20"></div>
